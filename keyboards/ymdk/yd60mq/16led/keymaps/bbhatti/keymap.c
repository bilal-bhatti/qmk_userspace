...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_all(
        ...
        _______, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_NO,   KC_NO,   KC_NO,   KC_NO,
        _______, KC_NO,   KC_NO,   KC_NO,   KC_NO,   MS_BTN2, MS_BTN1, MS_LEFT, MS_DOWN, MS_UP,   MS_RGHT, KC_NO,   KC_NO,   _______, KC_NO,
        KC_NO,   _______, _______,          KC_NO,   _______, KC_NO,            _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END
    ),
